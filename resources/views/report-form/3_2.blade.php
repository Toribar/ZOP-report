<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <div class="col-md-6">
                <select class="form-control" name="form_data[param_3_2_1]">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <select class="form-control" name="form_data[param_3_2_2]">
                    <option value="0">Da</option>
                    <option value="1">Ne</option>
                    <option value="2">Delimicno</option>
                </select>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <select class="form-control" name="form_data[param_3_2_3]">
                    <option value="0">Da</option>
                    <option value="1">Ne</option>
                    <option value="2">Delimicno</option>
                </select>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <select class="form-control" name="form_data[param_3_2_4]">
                    <option value="0">Da</option>
                    <option value="1">Ne</option>
                    <option value="2">Delimicno</option>
                </select>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input class="form-control" type="text" name="form_data[pressure_value]">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input class="form-control" type="date" name="form_data[date_measure]">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <select class="form-control" name="form_data[param_3_2_7]">
                    <option value="0">Da</option>
                    <option value="1">Ne</option>
                </select>
            </div>
